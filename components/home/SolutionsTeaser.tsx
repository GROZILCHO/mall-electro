...
const defaultContent: HomeFullContent["solutions"] = {
  badge: "Проектни сценарии",
  heading: "Решения според проектната ситуация",
  body:
    "Комбинираме услуги според конкретния обект - ново изграждане, модернизация, технологична линия, кабелна инфраструктура, сервиз или работа на височина.",
  allCta: "Виж всички решения",
  cardPrefix: "Решение",
  cardCta: "Виж решението",
  items: [
    { title: "Нов производствен обект", text: "Електро инфраструктура за нови производствени, складови и технологични обекти.", href: "/bg/reshenia/nov-proizvodstven-obekt", icon: "Factory" },
    { title: "Модернизация на електро система", text: "Оценка, подмяна и разширяване на съществуващи табла, трасета и захранвания.", href: "/bg/reshenia/modernizatsia-na-elektro-sistema", icon: "Settings" },
    { title: "Табла и автоматизация за технологични линии", text: "Комбинация от табла, управление, сензори, трасета и пуск на машини или линии.", href: "/bg/reshenia/tabla-i-avtomatizatsia-za-tehnologichni-linii", icon: "Cpu" },
    { title: "Кабелна инфраструктура за база", text: "Кабелни трасета, ниско напрежение и подредено окабеляване за индустриални бази.", href: "/bg/reshenia/kabelna-infrastruktura-za-baza", icon: "Activity" },
    { title: "Сервиз и разширяване", text: "Диагностика, поддръжка, подобрения и разширяване на работещи електро системи.", href: "/bg/reshenia/serviz-i-razshiryavane", icon: "Wrench" },
    { title: "Електромонтаж на височина с вишка", text: "Електромонтажни дейности във високи халета, складове и труднодостъпни точки.", href: "/bg/reshenia/elektromontazh-na-visochina-s-vishka", icon: "HardHat" },
  ],
};
      ...
      <div className="container relative z-10 mx-auto max-w-screen-xl px-6 lg:px-12">
        <div className="mb-14 grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-end">
          <FadeIn className="lg:col-span-8">
            <Badge text={content.badge} variant="blueprint" />
                ...
                >
                  <div className="mb-6 flex items-start justify-between border-b border-white pb-5">
                    <span className="font-mono text-[10px] font-bold uppercase tracking-widest text-gray-400">
                      {content.cardPrefix} {String(index + 1).padStart(2, "0")}
                    </span>
