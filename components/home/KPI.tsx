...
const metrics = [
  { 
    ...
    value: '15+', 
    label: 'Години опит',
    sub: 'В индустриалния сектор'
  },
  { 
    id: '02', 
    value: '120+', 
    label: 'Завършени проекта',
    sub: 'Индустриални инсталации'
  },
  { 
    id: '03', 
    value: '30+', 
    label: 'Ключови клиента',
    sub: 'ХВП и Агро индустрия'
  },
  { 
    id: '04', 
    value: '98%', 
    label: 'Удовлетвореност',
    sub: 'От дългосрочни партньори'
  },
];
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <FadeIn>
          <div className="flex items-center gap-4 mb-12 justify-center lg:justify-start">
             ...
             <h3 className="text-white font-mono text-sm uppercase tracking-[0.2em]">Инженерни Показатели</h3>
          </div>
        </FadeIn>
