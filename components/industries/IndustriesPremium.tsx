      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10 max-w-screen-xl">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
             ...
             {/* PANEL C - Mills */}
             <FadeIn delay={300}>
                <div id="industry-mills" className="bg-white rounded-2xl shadow-[0_8px_20px_rgba(0,0,0,0.03)] border-t-[3px] border-t-[#FF6D2E] border-x border-b border-gray-100 overflow-hidden hover:shadow-[0_8px_28px_rgba(0,0,0,0.08)] hover:-translate-y-2 transition-all duration-300 group h-full">
             ...
             {/* PANEL D - Agro */}
             <FadeIn delay={400}>
                <div id="industry-agro" className="bg-white rounded-2xl shadow-[0_8px_20px_rgba(0,0,0,0.03)] border-t-[3px] border-t-[#FF6D2E] border-x border-b border-gray-100 overflow-hidden hover:shadow-[0_8px_28px_rgba(0,0,0,0.08)] hover:-translate-y-2 transition-all duration-300 group h-full">
                   <div className="h-40 relative overflow-hidden">
