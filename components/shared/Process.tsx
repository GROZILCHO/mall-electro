...
const defaultContent: HomeFullContent["process"] = {
  heading: "Как работим",
  body: "Нашият процес гарантира предвидимост и резултати във всеки етап от проекта.",
  steps: [
...
interface ProcessProps {
  content?: HomeFullContent["process"];
}

const Process: React.FC<ProcessProps> = ({ content = defaultContent }) => {
  return (
      ...
      <div className="container mx-auto px-6 lg:px-12 max-w-screen-xl">
        <FadeIn>
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg font-light max-w-2xl mx-auto">{content.body}</p>
          </div>
        </FadeIn>
