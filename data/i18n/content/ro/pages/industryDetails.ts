...
const commonServices = [
  ...
  { title: "Mentenanță și service", text: "Diagnosticare, prevenție și suport tehnic după punerea în funcțiune.", href: "/ro/servicii/mentenanta-si-service", icon: "Wrench" },
] as const;
...
export const industryDetailsContent = {
  agriculture: createIndustry({
    ...
    overviewItems: ["Distribuția alimentării către utilaje, depozite, uscătoare și echipamente auxiliare.", "Trasee prin curți, hale, camere tehnice și zone exterioare, cu acces pentru mentenanță.", "Automatizarea transportului, uscării, liniilor tehnologice și punctelor de control.", "Organizarea service-ului în funcție de sarcina sezonieră și cerințele de fiabilitate."],
  ...
  foodIndustry: createIndustry({
    ...
    overviewItems: ["Alimentarea liniilor, utilajelor, tablourilor și punctelor de comandă.", "Trasee adaptate zonelor de igienă, accesului la echipamente și mentenanței.", "Automatizări pentru dozare, transport, ambalare, controlul procesului și siguranță.", "Infrastructură pentru diagnosticare, prevenție și extinderi viitoare."],
    ...
    needsText: "Domeniul electric depinde de amplasarea liniei, echipamente, mediu și cerințele operaționale.",
    needs: ["Echipamentele liniei, consumatorii și punctele de comandă.", "Traseele prin zonele de producție, ambalare și spațiile tehnice.", "Automatizările, semnalele, senzorii și integrarea proceselor.", "Accesul pentru mentenanță și abordarea service-ului în producție activă."],
  ...
  logistics: createIndustry({
    ...
    needsText: "Domeniul depinde de dimensiunea obiectivului, zonele de încărcare, echipamente și programul operațional.",
