...
export const serviceDetailsContent = {
  ...
  automation: createService({
    ...
    related: [["Tablouri electrice", "Tablouri de comandă și protecții.", "/ro/servicii/tablouri-electrice"], ["Instalații electrice industriale", "Legături către utilaje și linii.", "/ro/servicii/instalatii-electrice-industriale"], ["Trasee de cabluri", "Trasee pentru circuite de putere și comandă.", "/ro/servicii/trasee-de-cabluri"]],
  }),
  lowVoltage: createService({
    ...
    faq: [["Puteți conecta un consumator nou?", "Da, după verificarea capacității, protecțiilor și traseului disponibil."], ["Includeți marcarea circuitelor?", "Da, marcarea clară face parte din execuția organizată."], ["Se poate lucra împreună cu tabloul electric?", "Da, tabloul și distribuția pot fi tratate în cadrul aceleiași lucrări."]],
  ...
  maintenanceService: createService({
    ...
    overview: ["Colectarea istoricului și a simptomelor sistemului.", "Verificarea tablourilor, protecțiilor și conexiunilor.", "Controlul traseelor, cablurilor și marcajelor.", "Recomandări pentru corecții, mentenanță preventivă și modernizare."],
    ...
    steps: [["Diagnosticare inițială", "Clarificăm problema, istoricul și condițiile de funcționare."], ["Verificări", "Controlăm tablourile, traseele, conexiunile și protecțiile."], ["Corecții", "Remediem problemele identificate sau definim materialele și pașii necesari."], ["Raport și recomandări", "Prezentăm constatările și măsurile pentru mentenanță preventivă sau modernizare."]],
